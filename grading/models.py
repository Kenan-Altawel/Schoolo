...
# class AnnualResult(AutoCreateAndAutoUpdateTimeStampedModel):
#     """
#     نموذج لتخزين النتائج السنوية للطلاب
#     """
...
#         help_text=_("المعدل العام للطالب في هذا العام الدراسي")
#     )
...
#         help_text=_("يشير إلى ما إذا كان الطالب قد تم ترقيته للصف التالي")
#     )
...
#         ordering = ['-academic_year__name', 'student__user__last_name']
